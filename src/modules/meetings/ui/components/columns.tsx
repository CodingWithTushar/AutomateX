...
import { CircleCheckIcon, CircleXIcon, ClockArrowUpIcon, ClockFadingIcon, LoaderIcon, MoveRightIcon, VideoIcon } from "lucide-react";
import { Badge } from "@/components/ui/badge";
import { GetManyMeetingType } from "../../types";
...
export const columns: ColumnDef<GetManyMeetingType[number]>[] = [
  {
    accessorKey: "name",
    header: "Meeting Name",
    cell: ({ row }) => (
